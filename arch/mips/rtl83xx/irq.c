...
static void rtl83xx_ictl_enable_irq(struct irq_data *i)
{
	...
	value = rtl83xx_r32(RTL83XX_ICTL_GIMR);
	value |= BIT(i->irq);
	rtl83xx_w32(value, RTL83XX_ICTL_GIMR);
...
asmlinkage void plat_irq_dispatch(void)
{
	...
	if (pending & CAUSEF_IP7) {
		...
		ext_int = rtl83xx_r32(RTL83XX_ICTL_GIMR) & rtl83xx_r32(RTL83XX_ICTL_GISR);
...
int __init icu_of_init(struct device_node *node, struct device_node *parent)
{
	...
	rtl83xx_w32(RTL83XX_IRR0_SETTING, RTL83XX_IRR0);
	rtl83xx_w32(RTL83XX_IRR1_SETTING, RTL83XX_IRR1);
	rtl83xx_w32(RTL83XX_IRR2_SETTING, RTL83XX_IRR2);
	rtl83xx_w32(RTL83XX_IRR3_SETTING, RTL83XX_IRR3);

	/* Enable timer0 and uart0 interrupts */
	rtl83xx_w32(BIT(RTL83XX_IRQ_TC0) | BIT(RTL83XX_IRQ_UART0), RTL83XX_ICTL_GIMR);
