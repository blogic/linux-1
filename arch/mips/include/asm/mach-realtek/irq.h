...
/* Cascade map */
#define RTL8380_IRQ_UART0		2
#define RTL8380_IRQ_UART1		1
#define RTL8380_IRQ_TC0			5
#define RTL8380_IRQ_TC1			1
#define RTL8380_IRQ_OCPTO		1
#define RTL8380_IRQ_HLXTO		1
#define RTL8380_IRQ_SLXTO		1
#define RTL8380_IRQ_NIC			4
#define RTL8380_IRQ_GPIO_ABCD		4
#define RTL8380_IRQ_GPIO_EFGH		4
#define RTL8380_IRQ_RTC			4
#define	RTL8380_IRQ_SWCORE		3
#define RTL8380_IRQ_WDT_IP1		4
#define RTL8380_IRQ_WDT_IP2		5

/* Pack cascade map into interrupt routing registers */
#define RTL8380_IRR0_SETTING (\
	(RTL8380_IRQ_UART0	<< 28) | \
	(RTL8380_IRQ_UART1	<< 24) | \
	(RTL8380_IRQ_TC0	<< 20) | \
	(RTL8380_IRQ_TC1	<< 16) | \
	(RTL8380_IRQ_OCPTO	<< 12) | \
	(RTL8380_IRQ_HLXTO	<< 8)  | \
	(RTL8380_IRQ_SLXTO	<< 4)  | \
	(RTL8380_IRQ_NIC	<< 0))
#define RTL8380_IRR1_SETTING (\
	(RTL8380_IRQ_GPIO_ABCD	<< 28) | \
	(RTL8380_IRQ_GPIO_EFGH	<< 24) | \
	(RTL8380_IRQ_RTC	<< 20) | \
	(RTL8380_IRQ_SWCORE	<< 16))
